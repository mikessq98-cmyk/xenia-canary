...
// Discord RPC connects over a named pipe (\\.\pipe\discord-ipc-N), which is not
// reachable from the UWP App Container, and the discord-rpc third-party lib is
// excluded from the UWP build. Provide no-op stubs so xenia_main.cc is untouched.
namespace xe {
namespace discord {
