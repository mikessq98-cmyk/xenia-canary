...
class EmulatorWindow {
 public:
  ...
  void ToggleSettingsEditorDialog();
 ...
 private:
  ...
  void FileClose();
  void InstallContent();
  // Installs already-picked content packages (shared by the desktop and the
  // async UWP file-picker paths).
  void InstallContentPackages(std::vector<std::filesystem::path> paths);
  ...
  std::unique_ptr<SettingsEditorDialog> settings_editor_dialog_;
