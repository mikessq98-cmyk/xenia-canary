...
// The growable function-table API (registers unwind info for JIT-emitted code)
// is hidden behind the desktop partition, but ntdll exports it and it works in
// the App Container at runtime. Declare it so this builds.
extern "C" {
