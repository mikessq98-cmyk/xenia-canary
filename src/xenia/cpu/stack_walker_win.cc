...
// dbghelp (StackWalk64 / symbol resolution) is a desktop-only API and is not
// available in the UWP App Container; a stub StackWalker::Create is provided at
// the bottom of this file for XE_PLATFORM_WINRT.
...
#else  // XE_PLATFORM_WINRT

namespace xe {
namespace cpu {

std::unique_ptr<StackWalker> StackWalker::Create(backend::CodeCache*) {
  // No dbghelp in the App Container - stack capture/resolution is unavailable.
  return nullptr;
}
