...
// UWP / WinRT (Xbox Series App Container) detection. When building against the
// Windows Store / App partition, WINAPI_FAMILY == WINAPI_FAMILY_APP. This drives
// all of the `#if XE_PLATFORM_WINRT` guards in the UWP port (CoreWindow swap
// chains, sandboxed VFS, broker file access, etc.).
