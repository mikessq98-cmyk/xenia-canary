...
void* MapFileView(FileMappingHandle handle, void* base_address, size_t length,
  ...
  if (!mapping) {
    ...
    // the failure reason is the same at each of them. The error code is
    // essential for telling why a section can't be view-mapped at all (e.g.
    // commit charge for views of a not-fully-allocated file).
    ...
    // this base address for any later mapping attempt.
