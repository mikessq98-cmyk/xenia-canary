...
// The Win32 windowed-app context (HWND message loop, per-monitor DPI) is
// replaced by UWPWindowedAppContext in the App Container; the desktop types
// below (MONITOR_DPI_TYPE, ...) don't exist there, so compile it out.
