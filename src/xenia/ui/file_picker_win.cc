...
// The Win32 IFileDialog path is unavailable in the UWP App Container; the
// CoreWindow FolderPicker/FileOpenPicker implementation lives in
// file_picker_uwp.cc instead.
