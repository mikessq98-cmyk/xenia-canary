...
// The Win32 HWND window backend is replaced by UWPWindow in the App Container;
// its desktop-only members (WINDOWPLACEMENT, MONITOR_DPI_TYPE, ...) don't exist
// there, so compile the declaration out.
