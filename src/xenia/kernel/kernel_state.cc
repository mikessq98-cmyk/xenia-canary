...
void KernelState::InitializeKernelGuestGlobals() {
  ...
  XELOGI("KGG: processes initialized, before first guest trampoline");
  ...
  XELOGI("KGG: first guest trampoline ok -> 0x{:08X}",
         uint32_t(block->ExThreadObjectType.allocate_proc));
