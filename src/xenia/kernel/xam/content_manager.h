...
class ContentManager {
 public:
  ...
  // Redirects the host content storage root (e.g. to a "content" folder that
  // ships next to a raw default.xex - the JTAG/hdd layout where the game
  // expects Hdd1:\Content - so XamContentCreateEnumerator and direct file
  // access see the same packages). Call before the title starts.
